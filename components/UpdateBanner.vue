<template>
  ...
  >
    ...
    <div class="flex flex-1 justify-end">
      <button type="button" class="-m-3 p-3 focus-visible:outline-offset-[-4px]" @click="versionAcknowledged = true">
...
const versionAcknowledged = useStorage("versionAcknowledged", false);
</script>
